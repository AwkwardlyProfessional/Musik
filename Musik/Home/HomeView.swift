        ...
        ZStack {
            ...
            ScrollView(.vertical, showsIndicators: false) {
                VStack(alignment: .leading, spacing: 0) {
                    ...
                    // Playlists
                    HomePlaylistView(playlists: viewModel.playlists) { music in
                    ...
                    // Recently Played
                    HomeRecentlyPlayedView(recentlyPlayed: viewModel.recentlyPlayed) { music in
                        withAnimation(.spring()) {
                            viewModel.selectMusic(music: music)
                        }
                    }
            ...
            .edgesIgnoringSafeArea([.horizontal, .bottom]) // removed deprecated `.animation()`
        }
    }
}
